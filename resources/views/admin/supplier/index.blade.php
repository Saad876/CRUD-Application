        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            <b style="float: right;">Total Suppliers: <span><i class="fas fa-industry"></i></span>
                <span class="badge rounded-pill badge-notification bg-danger"
                      style="color: #fff;">{{count($suppliers_count)}}</span></b>
        </h2>
    </x-slot>
                ...
                <div class="col-md-8">
                    <div class="card bg-dark text-white border-primary">
                        ...
                        <div class="card-body">
                            <table class="table table-dark">
                                ...
                                @foreach($suppliers as $supplier)
                                    ...
                                    <!-- <th scope="row">{{-- {{$i++}}--}} </th> -->
                                        ...
                                        <td><img src="{{ asset($supplier->supplier_image) }}"
                                        ...
                                        <td>
                                            <a href="{{url('/supplier/edit/'.$supplier->id)}}" class="btn btn-info"
                                               title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="{{url('/supplier/delete/'.$supplier->id)}}"
                                               onclick="return confirm('Are you want to delete!')"
                                               class="btn btn-danger" title="Soft Delete"><i
                            ...
                            <div
                                class="card-footer bg-transparent border-success text-light">{{$suppliers->links()}}</div>
                        </div>
                    </div>
                </div>
